async function loadDashboard() {
  ...
  // Executive Mode Actions
  function renderActions(actions, executiveMode = true) {
    ...
    const filteredActions = executiveMode
  ...
  const executiveMode = executiveModeToggle ? executiveModeToggle.checked : true;
  renderActions(data.actions, executiveMode);

  if (executiveModeToggle) {
    executiveModeToggle.addEventListener('change', () => {
      renderActions(data.actions, executiveModeToggle.checked);
    });
  }
}
